...
class MklLapack(Package):
    ...
    pkg_dir = spack.db.dirname_for_package_name("mkl-lapack")
            ...
            if os.path.isdir(mklroot):
                ...
                if spec.satisfies('%gcc'):
                    ...
                    if spec.satisfies('+shared'):
                        ...
                        module.lapackparlibname=["-L"+mkllibdir+" -lmkl_intel_lp64 -lmkl_core -lmkl_intel_thread -lpthread -lm"]
                    else:
                        module.lapacklibname=["-Wl,--start-group "+mkllibdir+"libmkl_intel_lp64.a "+mkllibdir+"libmkl_core.a "+mkllibdir+"libmkl_sequential.a -Wl,--end-group -lpthread -lm"]
                        module.lapackparlibname=["-Wl,--start-group "+mkllibdir+"libmkl_intel_lp64.a "+mkllibdir+"libmkl_core.a "+mkllibdir+"libmkl_intel_thread.a -Wl,--end-group -lpthread -lm"]

                ...
                if spec.satisfies('%gcc'):
                    if spec.satisfies('+shared'):
                        if spec.satisfies('+mt'):
                            module.lapacklibname=["-Wl,--no-as-needed -L"+mkllibdir+" -lmkl_intel_lp64 -lmkl_core -lmkl_gnu_thread -ldl -lgomp -lpthread -lm"]
                            module.lapacklibfortname=["-Wl,--no-as-needed -L"+mkllibdir+" -lmkl_gf_lp64 -lmkl_core -lmkl_gnu_thread -ldl -lgomp -lpthread -lm"]
                        else:

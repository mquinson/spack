    ...
    def setup_dependent_environment(self, module, spec, dep_spec):
        if os.getenv('MKLROOT'):
            ...
            if os.path.isdir(mklroot):
                """Dependencies of this package will get the libraries names for mkl-lapacke."""
                ...
                if spec.satisfies('%gcc'):
                    if spec.satisfies('+shared'):
                        ...
                        module.lapackeparlibname=["-Wl,--no-as-needed -L"+mkllibdir+" -lmkl_intel_lp64 -lmkl_core -lmkl_intel_thread -ldl -liomp5 -lpthread -lm"]
                        module.lapackelibfortname=["-Wl,--no-as-needed -L"+mkllibdir+" -lmkl_gf_lp64 -lmkl_core -lmkl_sequential -lpthread -lm"]
                        module.lapackeparlibfortname=["-Wl,--no-as-needed -L"+mkllibdir+" -lmkl_gf_lp64 -lmkl_core -lmkl_intel_thread -ldl -liomp5 -lpthread -lm"]
                    else:
                        ...
                        module.lapackeparlibname=["-Wl,--start-group "+mkllibdir+"libmkl_intel_lp64.a "+mkllibdir+"libmkl_core.a "+mkllibdir+"libmkl_intel_thread.a -Wl,--end-group -ldl -liomp5 -lpthread -lm"]
                        ...
                        module.lapackeparlibfortname=["-Wl,--start-group "+mkllibdir+"libmkl_gf_lp64.a "+mkllibdir+"libmkl_core.a "+mkllibdir+"libmkl_intel_thread.a -Wl,--end-group -ldl -liomp5 -lpthread -lm"]
                elif spec.satisfies('%icc'):
                    if spec.satisfies('+shared'):
                        module.lapackelibname=["-L"+mkllibdir+" -lmkl_intel_lp64 -lmkl_core -lmkl_sequential -lpthread -lm"]
                        module.lapackeparlibname=["-L"+mkllibdir+" -lmkl_intel_lp64 -lmkl_core -lmkl_intel_thread -lpthread -lm"]
                    else:
                        module.lapackelibname=["-Wl,--start-group "+mkllibdir+"libmkl_intel_lp64.a "+mkllibdir+"libmkl_core.a "+mkllibdir+"libmkl_sequential.a -Wl,--end-group -lpthread -lm"]
                        module.lapackeparlibname=["-Wl,--start-group "+mkllibdir+"libmkl_intel_lp64.a "+mkllibdir+"libmkl_core.a "+mkllibdir+"libmkl_intel_thread.a -Wl,--end-group -lpthread -lm"]

...
class Metis(Package):
    ...
    depends_on('cmake', when='@5:')  # build-time dependency
    ...
    def setup_dependent_package(self, module, dep_spec):
        """Dependencies of this package will get the link for Metis."""
        self.spec.cc_link="-L%s -lmetis" % self.spec.prefix.lib

...
class Starpu(Package):
    ...
    version('nightly-1.2',
            url="http://starpu.gforge.inria.fr/testing/branches/starpu-1.2/starpu-nightly-latest.tar.gz")
    version('nightly-1.1',
            url="http://starpu.gforge.inria.fr/testing/branches/starpu-1.1/starpu-nightly-latest.tar.gz")

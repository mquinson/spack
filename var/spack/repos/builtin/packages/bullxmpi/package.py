    ...
    def install(self, spec, prefix):
        if os.getenv('BULLXMPI_DIR'):
            ...
            if os.path.isdir(bullxmpiroot):
                ...
                raise RuntimeError(bullxmpiroot+' directory does not exist.'+' Do you really have openmpi installed in '+bullxmpiroot+' ?')
        else:
            raise RuntimeError('BULLXMPI_DIR is not set, you must set this environment variable to the installation path of your bullxmpi')
